...
namespace MusicNewsApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            MenuMusics.Add(new MenuMusic { IconFile = "Assets/Icons/animals.png", Category = MusicCategory.NhacHoa });
            MenuMusics.Add(new MenuMusic { IconFile = "Assets/Icons/cartoon.png", Category = MusicCategory.NhacNhat });
            MenuMusics.Add(new MenuMusic { IconFile = "Assets/Icons/taunt.png", Category = MusicCategory.VietNam });
            MenuMusics.Add(new MenuMusic { IconFile = "Assets/Icons/warning.png", Category = MusicCategory.Yeuthich });
